...
//OBJECT.KEYS()
console.log(Object.keys(a1)); //['a', 'b', 'c']
console.log(Object.keys(a2)); //['0', '1', '2']
console.log(Object.keys('Reyco')); //["0", "1", "2", "3", "4"]
...
a3.e = 5;
console.log(a3); //{a: 1, b: 2, c: 3, d: 4, e: 5}

/******************* DELETING PROPERTIES *******************/
delete a3.e;
console.log(a3); //{a: 1, b: 2, c: 3, d: 4}
delete a3['d'];
console.log(a3); //{a: 1, b: 2, c: 3}
